            ...
            "cells": [
                {
                    ...
                    "source": [
                        ...
                        "# Verify transformers is importable before handing off to remote_worker.\n",
                        "try:\n",
                        "    import transformers\n",
                        "    print(f'transformers {transformers.__version__} ready', flush=True)\n",
                        "except ImportError as _e:\n",
                        "    raise RuntimeError(f'transformers not importable after install: {_e}  sys.path={sys.path}') from _e\n",
                        "\n",
